...
Приложение для извлечения числовых данных из изображений двумерных графиков. Ручной режим работы с визуальными инструментами для приближенного оцифровывания кривых и точек. Сделано на коленке при помощи ИИ.
