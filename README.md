...
Приложение для извлечения числовых данных из изображений двумерных графиков. Ручной режим работы с визуальными инструментами для точного оцифровывания кривых и точек.
